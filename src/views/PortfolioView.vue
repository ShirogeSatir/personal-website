      ...
      items: [
        {
          ...
          imageUrl: 'personal-website',
          status: 'My personal website, I created this website to display my profile, skills and projects. As well as my place to try new technology.',
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/RaolMarketplace/personal-website',
          demo: 'https://ralvinstore.my.id/'
        },
        {
          id: 2,
          name: 'web marketplace',
          imageUrl: 'personal-marketplace',
          status: 'A website that has a responsive appearance to make it easier for cloud stores & marketplaces to sell products.',
          tech: 'Html, Css, Javascript',
          github: 'https://github.com/RaolMarketplace/personal-store',
          demo: 'https://ralvinstore.my.id/'
        }
      ]
    };
